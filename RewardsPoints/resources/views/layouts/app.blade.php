...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title><?php //{{ config('app.name', 'Laravel') }}  ?> The Founder Corp</title>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ url('rewardshistory') }}">List All Order</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">                           
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Rewards Stock<span class="caret"></span></a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="{{ url('rewardsstock') }}">List All Rewards</a></li>
                                    <li><a href="{{ url('addrewards') }}">Add Rewards</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">                           
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="{{ url('points') }}">Points Settings</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
